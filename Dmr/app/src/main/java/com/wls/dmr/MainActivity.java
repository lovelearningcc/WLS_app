...
import com.wls.dmr.activity.BaseFragmentActivity;

import com.wls.dmr.fragment.FunctionFragment;
import com.wls.dmr.fragment.HomeFragment;
import com.wls.dmr.fragment.MeFragment;
import com.wls.dmr.utils.SharePreUtil;
...
public class MainActivity extends BaseFragmentActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_menu_bottom_function://点击功能模块执行
                IsTab = 1;
                setSelected2(menu_bottom_function);
    ...
    public void setSelected2(TextView textView) {
        menu_bottom_home.setSelected(false);
        menu_bottom_me.setSelected(false);
        textView.setSelected(true);
    }
