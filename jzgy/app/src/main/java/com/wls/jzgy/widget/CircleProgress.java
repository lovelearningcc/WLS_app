...
public class CircleProgress extends View {
    ...
    protected void initVar(Context context, AttributeSet attrs) {
        ...
        bgPaintColor = ta.getColor(R.styleable.CircleProgress_bgColor, 0x66ffffff);
        foreStartColor = ta.getColor(R.styleable.CircleProgress_foreStartColor, 0x3295AB);
        foreEndColcor = ta.getColor(R.styleable.CircleProgress_foreEndColor, 0x3295AB);
        maxProgress = ta.getInteger(R.styleable.CircleProgress_maxProgress, 360);
        ...
        progressInitialPosition = ta.getInteger(R.styleable.CircleProgress_progressInitialPosition, 270);
    ...
    public void setProColor(int start,int end){
        foreStartColor=start;
        foreEndColcor=end;
    }
}
