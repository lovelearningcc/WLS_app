...
public class SystimeActivity extends Activity implements View.OnClickListener {
    ...
    private String seid, sphonenumber, simei, stype, suid;
...
//            tystr0 = Integer.toHexString(Integer.parseInt(timed1.getText().toString().trim()));
//            tystr1 = Integer.toHexString(Integer.parseInt(times1.getText().toString().trim()));
//            tystr2 = Integer.toHexString(Integer.parseInt(timef1.getText().toString().trim()));
//            tystr3 = Integer.toHexString(Integer.parseInt(timey1.getText().toString().trim()));
//            tystr4 = Integer.toHexString(Integer.parseInt(timem1.getText().toString().trim()));
//            tystr5 = Integer.toHexString(Integer.parseInt(timen1.getText().toString().trim()));

//            Log.e("大菠萝", "时间是---------》" + tystr2);
//            Log.e("大菠萝", "时间是---------》" + tystr3);
//            Log.e("大菠萝", "时间是---------》" + tystr4);
    ...
    private void initListen() {
        ...
        timen1.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    timen1.setText("");
//                    timen1.setFocusable(true);
//                    timen1.setFocusableInTouchMode(true);
//                    timen1.requestFocus();
                }
            }
        });
...
//                        Log.e(TAG, "测试值为---------->>>" + qw);
                        ...
                        mstate = true;
//                            String yspj1 = tc2.testStringBuilder2(tystr0,tystr1,tystr2,tystr3,tystr4,tystr5);
//                            dmrbell2(yspj1,"0150");
