package com.wls.jzgy.temp.fragments;
...
import com.wls.jzgy.temp.adaptes.CommonFragmentAdapter;
import com.wls.jzgy.temp.domain.CommonFragData;
import com.wls.jzgy.temp.domain.UpdateTimeData;
import com.wls.jzgy.temp.utils.SpUtils;
...
import static com.wls.jzgy.temp.activitys.CheckInfoMainActivity.UPDATE_TIME_DATA;
import static com.wls.jzgy.temp.utils.UrlUtils.URL_CHECK_USER;
import static com.wls.jzgy.temp.utils.UrlUtils.URL_DAY;
import static com.wls.jzgy.temp.utils.UrlUtils.URL_LASE_WEEK;
import static com.wls.jzgy.temp.utils.UrlUtils.URL_MONTH;
import static com.wls.jzgy.temp.utils.UrlUtils.URL_PAY_MENT;
import static com.wls.jzgy.temp.utils.UrlUtils.URL_THIS_WEEK;
...
public class CommonFragment extends Fragment {
    private static final String TAG = "CommonFragment1";
    ...
    /**
     * 从 CheckInfoMainActivity1 传过来的数据
     */
    @Subscribe()
    public void Events(UpdateTimeData event) {
        Log.i(TAG, "event:" + event);
        if (event.getTag().equals(UPDATE_TIME_DATA)) {
            mTime = event.getTime();
            pageCount = 1;
            dataArrayList.clear();
            initNetData();
