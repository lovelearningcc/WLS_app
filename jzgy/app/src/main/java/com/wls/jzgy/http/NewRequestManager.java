...
public class NewRequestManager {
     ...
     * 获取类名
     */
    private  final String TAG = NewRequestManager.class.getSimpleName();
    /**
     * 单利引用
     */
    private static volatile NewRequestManager mInstance;
     ...
     * 初始化RequestManager
     */
    public NewRequestManager(Context context) {
        //初始化OkHttpClient
     ...
     * @return
     */
    public static NewRequestManager getInstance(Context context) {
        NewRequestManager inst = mInstance;
        if (inst == null) {
            synchronized (NewRequestManager.class) {
                inst = mInstance;
                if (inst == null) {
                    inst = new NewRequestManager(context.getApplicationContext());
                    mInstance = inst;
                }
            }
        }
