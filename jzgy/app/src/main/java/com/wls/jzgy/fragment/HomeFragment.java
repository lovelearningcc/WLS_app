...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    private TextView tonlineNum;

    private MyListView listuser;
    /**
    ...
    //gcc_add
//    private String uid = "1075322733292220417";
    ...
    //private String eid, type, msg, timestamps, str1, province, city;
    private String msg, timestamps, str1;
//    private String eid;
//    private String type;
//    private JSONObject data;
    private String hospital, province, city, num;
...
//    };
    ...
    public void getUserData7(int flag) {  //获取在线、离线设备
        ...
        zhiShui.setEtypecode(ConsTant.ETYPECODE_JZGY);
...
//            mapDay.put("uid", myuid);
        ...
        okHttpUtils3.requestAsyn(url, OkHttpUtils3.TYPE_POST_JSON, json, new ReqCallBack<String>() {
...
//                                    String yasuo = userData.getEid();
//                                    Log.e(TAG, "得到的值为：----------》》》》》" + yasuo);
...
//                pb_load.setVisibility(View.INVISIBLE);
//                Log.d(TAG, "9:49请求失败------------>");
                Toast.makeText(getActivity(), "请求数据失败1111！" + errorMsg, Toast.LENGTH_SHORT).show();
                ll_no_data[flag].setVisibility(View.VISIBLE);
